    ...
    routes.forEach(router => {
        ...
        let fmRouter = {
            ...
            component(resolve) {
                ...
                }else if (component.startsWith("Attendance")) {
                    require(['../views/attendance/' + component + '.vue'], resolve);
                }else if (component.startsWith("Bp")) {
                ...
                }else if (component.startsWith("Recruit")) {
